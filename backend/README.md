...
## Project Structure
    ...
    ├── test_app_online_boo_38114  # Django project configurations
...
1. Clone this repo and `cd test_app_online_boo_38114`
...
2. Clone this repo and `cd test_app_online_boo_38114`
